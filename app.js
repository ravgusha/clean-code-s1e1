...
var completedTasksHolder = document.getElementById("completeTasks"); //completed-tasks
...
console.log(taskString)
    ...
    editInput.type = "text";
    editInput.className = "task__add button";
...
document.querySelector(".section__form").onclick = ()=> {
    return false;
}
...
var editTask = function () {
    ...
    var editInput = listItem.querySelector('.task__add');
